...
//! Generated file from `tensorflow/core/example/example.proto`
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0c\n\x05\x04\0\x02\0\x06\x12\x03X\x02\n\n\x0c\n\x05\x04\0\x02\0\x01\
    \x12\x03X\x0b\x13\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03X\x16\x17\n\x8d5\n\
    \x02\x04\x01\x12\x06\xa9\x02\0\xac\x02\x012\xfe4\x20A\x20SequenceExample\
    \x20is\x20an\x20Example\x20representing\x20one\x20or\x20more\x20sequence\
    s,\x20and\n\x20some\x20context.\x20\x20The\x20context\x20contains\x20fea\
    tures\x20which\x20apply\x20to\x20the\x20entire\n\x20example.\x20The\x20f\
    eature_lists\x20contain\x20a\x20key,\x20value\x20map\x20where\x20each\
    \x20key\x20is\n\x20associated\x20with\x20a\x20repeated\x20set\x20of\x20F\
    eatures\x20(a\x20FeatureList).\n\x20A\x20FeatureList\x20thus\x20represen\
    ts\x20the\x20values\x20of\x20a\x20feature\x20identified\x20by\x20its\x20\
    key\n\x20over\x20time\x20/\x20frames.\n\n\x20Below\x20is\x20a\x20Sequenc\
    eExample\x20for\x20a\x20movie\x20recommendation\x20application\x20record\
    ing\x20a\n\x20sequence\x20of\x20ratings\x20by\x20a\x20user.\x20The\x20ti\
    me-independent\x20features\x20(\"locale\",\n\x20\"age\",\x20\"favorites\
    \")\x20describing\x20the\x20user\x20are\x20part\x20of\x20the\x20context.\
    \x20The\x20sequence\n\x20of\x20movies\x20the\x20user\x20rated\x20are\x20\
    part\x20of\x20the\x20feature_lists.\x20For\x20each\x20movie\x20in\x20the\
    \n\x20sequence\x20we\x20have\x20information\x20on\x20its\x20name\x20and\
    \x20actors\x20and\x20the\x20user's\x20rating.\n\x20This\x20information\
    \x20is\x20recorded\x20in\x20three\x20separate\x20feature_list(s).\n\x20I\
    n\x20the\x20example\x20below\x20there\x20are\x20only\x20two\x20movies.\
    \x20All\x20three\x20feature_list(s),\n\x20namely\x20\"movie_ratings\",\
    \x20\"movie_names\",\x20and\x20\"actors\"\x20have\x20a\x20feature\x20val\
    ue\x20for\n\x20both\x20movies.\x20Note,\x20that\x20\"actors\"\x20is\x20i\
    tself\x20a\x20bytes_list\x20with\x20multiple\n\x20strings\x20per\x20movi\
    e.\n\n\x20context:\x20{\n\x20\x20\x20feature:\x20{\n\x20\x20\x20\x20\x20\
    key\x20\x20:\x20\"locale\"\n\x20\x20\x20\x20\x20value:\x20{\n\x20\x20\
    \x20\x20\x20\x20\x20bytes_list:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20value:\x20[\x20\"pt_BR\"\x20]\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\
    \x20\x20\x20\x20}\n\x20\x20\x20}\n\x20\x20\x20feature:\x20{\n\x20\x20\
    \x20\x20\x20key\x20\x20:\x20\"age\"\n\x20\x20\x20\x20\x20value:\x20{\n\
    \x20\x20\x20\x20\x20\x20\x20float_list:\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20value:\x20[\x2019.0\x20]\n\x20\x20\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20}\n\x20\x20\x20feature:\x20{\n\x20\
    \x20\x20\x20\x20key\x20\x20:\x20\"favorites\"\n\x20\x20\x20\x20\x20value\
    :\x20{\n\x20\x20\x20\x20\x20\x20\x20bytes_list:\x20{\n\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20value:\x20[\x20\"Majesty\x20Rose\",\x20\"Savannah\
    \x20Outen\",\x20\"One\x20Direction\"\x20]\n\x20\x20\x20\x20\x20\x20\x20}\
    \n\x20\x20\x20\x20\x20}\n\x20\x20\x20}\n\x20}\n\x20feature_lists:\x20{\n\
    \x20\x20\x20feature_list:\x20{\n\x20\x20\x20\x20\x20key\x20\x20:\x20\"mo\
    vie_ratings\"\n\x20\x20\x20\x20\x20value:\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20feature:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20float_list:\x20{\
    \n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20value:\x20[\x204.5\x20]\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20\x20\x20feature:\x20{\n\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20float_list:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20va\
    lue:\x20[\x205.0\x20]\n\x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\x20}\n\x20\x20\
    \x20feature_list:\x20{\n\x20\x20\x20\x20\x20key\x20\x20:\x20\"movie_name\
    s\"\n\x20\x20\x20\x20\x20value:\x20{\n\x20\x20\x20\x20\x20\x20\x20featur\
    e:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20bytes_list:\x20{\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20value:\x20[\x20\"The\x20Shawshank\
    \x20Redemption\"\x20]\n\x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\x20feature:\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20bytes_list:\x20{\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20value:\x20[\x20\"Fight\x20Club\"\x20]\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20}\n\x20\x20\x20}\n\x20\x20\x20feature_list:\x20{\n\x20\x20\
    \x20\x20\x20key\x20\x20:\x20\"actors\"\n\x20\x20\x20\x20\x20value:\x20{\
    \n\x20\x20\x20\x20\x20\x20\x20feature:\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20bytes_list:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20value:\x20[\x20\"Tim\x20Robbins\",\x20\"Morgan\x20Freeman\"\x20]\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\x20\x20}\n\
    \x20\x20\x20\x20\x20\x20\x20feature:\x20{\n\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20bytes_list:\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20va\
    lue:\x20[\x20\"Brad\x20Pitt\",\x20\"Edward\x20Norton\",\x20\"Helena\x20B\
    onham\x20Carter\"\x20]\n\x20\x20\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\x20}\n\x20}\n\n\
    \x20A\x20conformant\x20SequenceExample\x20data\x20set\x20obeys\x20the\
    \x20following\x20conventions:\n\n\x20Context:\n\x20\x20\x20-\x20All\x20c\
    onformant\x20context\x20features\x20K\x20must\x20obey\x20the\x20same\x20\
    conventions\x20as\n\x20\x20\x20\x20\x20a\x20conformant\x20Example's\x20f\
    eatures\x20(see\x20above).\n\x20Feature\x20lists:\n\x20\x20\x20-\x20A\
    \x20FeatureList\x20L\x20may\x20be\x20missing\x20in\x20an\x20example;\x20\
    it\x20is\x20up\x20to\x20the\n\x20\x20\x20\x20\x20parser\x20configuration\
    \x20to\x20determine\x20if\x20this\x20is\x20allowed\x20or\x20considered\n\
    \x20\x20\x20\x20\x20an\x20empty\x20list\x20(zero\x20length).\n\x20\x20\
    \x20-\x20If\x20a\x20FeatureList\x20L\x20exists,\x20it\x20may\x20be\x20em\
    pty\x20(zero\x20length).\n\x20\x20\x20-\x20If\x20a\x20FeatureList\x20L\
    \x20is\x20non-empty,\x20all\x20features\x20within\x20the\x20FeatureList\
    \n\x20\x20\x20\x20\x20must\x20have\x20the\x20same\x20data\x20type\x20T.\
    \x20Even\x20across\x20SequenceExamples,\x20the\x20type\x20T\n\x20\x20\
    \x20\x20\x20of\x20the\x20FeatureList\x20identified\x20by\x20the\x20same\
    \x20key\x20must\x20be\x20the\x20same.\x20An\x20entry\n\x20\x20\x20\x20\
    \x20without\x20any\x20values\x20may\x20serve\x20as\x20an\x20empty\x20fea\
    ture.\n\x20\x20\x20-\x20If\x20a\x20FeatureList\x20L\x20is\x20non-empty,\
    \x20it\x20is\x20up\x20to\x20the\x20parser\x20configuration\n\x20\x20\x20\
    \x20\x20to\x20determine\x20if\x20all\x20features\x20within\x20the\x20Fea\
    tureList\x20must\n\x20\x20\x20\x20\x20have\x20the\x20same\x20size.\x20\
    \x20The\x20same\x20holds\x20for\x20this\x20FeatureList\x20across\x20mult\
    iple\n\x20\x20\x20\x20\x20examples.\n\x20\x20\x20-\x20For\x20sequence\
    \x20modeling,\x20e.g.:\n\x20\x20\x20\x20\x20\x20\x20\x20http://colah.git\
    hub.io/posts/2015-08-Understanding-LSTMs/\n\x20\x20\x20\x20\x20\x20\x20\
    \x20https://github.com/tensorflow/nmt\n\x20\x20\x20\x20\x20the\x20featur\
    e\x20lists\x20represent\x20a\x20sequence\x20of\x20frames.\n\x20\x20\x20\
    \x20\x20In\x20this\x20scenario,\x20all\x20FeatureLists\x20in\x20a\x20Seq\
    uenceExample\x20have\x20the\x20same\n\x20\x20\x20\x20\x20number\x20of\
    \x20Feature\x20messages,\x20so\x20that\x20the\x20ith\x20element\x20in\
    \x20each\x20FeatureList\n\x20\x20\x20\x20\x20is\x20part\x20of\x20the\x20\
    ith\x20frame\x20(or\x20time\x20step).\n\x20Examples\x20of\x20conformant\
    \x20and\x20non-conformant\x20examples'\x20FeatureLists:\n\n\x20Conforman\
    t\x20FeatureLists:\n\x20\x20\x20\x20feature_lists:\x20{\x20feature_list:\
    \x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\x20\
    \x20\x20\x20value:\x20{\x20feature:\x20{\x20float_list:\x20{\x20value:\
    \x20[\x204.5\x20]\x20}\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x20\
    5.0\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\n\x20Non-conformant\
    \x20FeatureLists\x20(mismatched\x20types):\n\x20\x20\x20\x20feature_list\
    s:\x20{\x20feature_list:\x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_r\
    atings\"\n\x20\x20\x20\x20\x20\x20value:\x20{\x20feature:\x20{\x20float_\
    list:\x20{\x20value:\x20[\x204.5\x20]\x20}\x20}\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20feature:\x20{\x20int64_list:\x20\
    {\x20value:\x20[\x205\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\n\
    \x20Conditionally\x20conformant\x20FeatureLists,\x20the\x20parser\x20con\
    figuration\x20determines\n\x20if\x20the\x20feature\x20sizes\x20must\x20m\
    atch:\n\x20\x20\x20\x20feature_lists:\x20{\x20feature_list:\x20{\n\x20\
    \x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\x20\x20\x20\x20v\
    alue:\x20{\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x204.5\
    \x20]\x20}\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x205.0,\x206.0\
    \x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\n\x20Conformant\x20pair\
    \x20of\x20SequenceExample\n\x20\x20\x20\x20feature_lists:\x20{\x20featur\
    e_list:\x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\
    \x20\x20\x20\x20\x20value:\x20{\x20feature:\x20{\x20float_list:\x20{\x20\
    value:\x20[\x204.5\x20]\x20}\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\
    \x205.0\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\x20and:\n\x20\x20\
    \x20\x20feature_lists:\x20{\x20feature_list:\x20{\n\x20\x20\x20\x20\x20\
    \x20key:\x20\"movie_ratings\"\n\x20\x20\x20\x20\x20\x20value:\x20{\x20fe\
    ature:\x20{\x20float_list:\x20{\x20value:\x20[\x204.5\x20]\x20}\x20}\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20feature:\x20\
    {\x20float_list:\x20{\x20value:\x20[\x205.0\x20]\x20}\x20}\n\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20feature:\x20{\x20float_l\
    ist:\x20{\x20value:\x20[\x202.0\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\
    \x20}\n\n\x20Conformant\x20pair\x20of\x20SequenceExample\n\x20\x20\x20\
    \x20feature_lists:\x20{\x20feature_list:\x20{\n\x20\x20\x20\x20\x20\x20k\
    ey:\x20\"movie_ratings\"\n\x20\x20\x20\x20\x20\x20value:\x20{\x20feature\
    :\x20{\x20float_list:\x20{\x20value:\x20[\x204.5\x20]\x20}\x20}\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20feature:\x20{\
    \x20float_list:\x20{\x20value:\x20[\x205.0\x20]\x20}\x20}\x20}\n\x20\x20\
    \x20\x20}\x20}\n\x20and:\n\x20\x20\x20\x20feature_lists:\x20{\x20feature\
    _list:\x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\
    \x20\x20\x20\x20value:\x20{\x20}\n\x20\x20\x20\x20}\x20}\n\n\x20Conditio\
    nally\x20conformant\x20pair\x20of\x20SequenceExample,\x20the\x20parser\
    \x20configuration\n\x20determines\x20if\x20the\x20second\x20feature_list\
    s\x20is\x20consistent\x20(zero-length)\x20or\n\x20invalid\x20(missing\
    \x20\"movie_ratings\"):\n\x20\x20\x20\x20feature_lists:\x20{\x20feature_\
    list:\x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\
    \x20\x20\x20\x20value:\x20{\x20feature:\x20{\x20float_list:\x20{\x20valu\
    e:\x20[\x204.5\x20]\x20}\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x20\
    5.0\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\x20and:\n\x20\x20\x20\
    \x20feature_lists:\x20{\x20}\n\n\x20Non-conformant\x20pair\x20of\x20Sequ\
    enceExample\x20(mismatched\x20types)\n\x20\x20\x20\x20feature_lists:\x20\
    {\x20feature_list:\x20{\n\x20\x20\x20\x20\x20\x20key:\x20\"movie_ratings\
    ...
    ue:\x20[\x205.0\x20]\x20}\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\x20and:\n\
    \x20\x20\x20\x20feature_lists:\x20{\x20feature_list:\x20{\n\x20\x20\x20\
    \x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\x20\x20\x20\x20value:\
    \x20{\x20feature:\x20{\x20int64_list:\x20{\x20value:\x20[\x204\x20]\x20}\
    \x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20featu\
    re:\x20{\x20int64_list:\x20{\x20value:\x20[\x205\x20]\x20}\x20}\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20feature:\x20{\
    \x20int64_list:\x20{\x20value:\x20[\x202\x20]\x20}\x20}\x20}\n\x20\x20\
    \x20\x20}\x20}\n\n\x20Conditionally\x20conformant\x20pair\x20of\x20Seque\
    nceExample;\x20the\x20parser\x20configuration\n\x20determines\x20if\x20t\
    he\x20feature\x20sizes\x20must\x20match:\n\x20\x20\x20\x20feature_lists:\
    ...
    and:\n\x20\x20\x20\x20feature_lists:\x20{\x20feature_list:\x20{\n\x20\
    \x20\x20\x20\x20\x20key:\x20\"movie_ratings\"\n\x20\x20\x20\x20\x20\x20v\
    alue:\x20{\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x204.0\
    \x20]\x20}\x20}\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20feature:\x20{\x20float_list:\x20{\x20value:\x20[\x205.0,\x203.0\
    \x20]\x20}\x20}\n\x20\x20\x20\x20}\x20}\n\n\x0b\n\x03\x04\x01\x01\x12\
    \x04\xa9\x02\x08\x17\n\x0c\n\x04\x04\x01\x02\0\x12\x04\xaa\x02\x02\x17\n\
    \r\n\x05\x04\x01\x02\0\x06\x12\x04\xaa\x02\x02\n\n\r\n\x05\x04\x01\x02\0\
    \x01\x12\x04\xaa\x02\x0b\x12\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xaa\x02\
    \x15\x16\n\x0c\n\x04\x04\x01\x02\x01\x12\x04\xab\x02\x02!\n\r\n\x05\x04\
    \x01\x02\x01\x06\x12\x04\xab\x02\x02\x0e\n\r\n\x05\x04\x01\x02\x01\x01\
    \x12\x04\xab\x02\x0f\x1c\n\r\n\x05\x04\x01\x02\x01\x03\x12\x04\xab\x02\
    \x1f\x20b\x06proto3\
";
