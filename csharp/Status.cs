...
namespace Tensorflow.Serving {
    ...
    static StatusReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cmZsb3cuc2VydmluZxoqdGVuc29yZmxvdy9jb3JlL2xpYi9jb3JlL2Vycm9y",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Tensorflow.Serving.StatusProto), global::Tensorflow.Serving.StatusProto.Parser, new[]{ "ErrorCode", "ErrorMessage" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class StatusProto : pb::IMessage<StatusProto> {
    ...
    private global::Tensorflow.Error.Code errorCode_ = global::Tensorflow.Error.Code.Ok;
    /// <summary>
    /// Error code.
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (ErrorCode != global::Tensorflow.Error.Code.Ok) hash ^= ErrorCode.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      if (ErrorCode != global::Tensorflow.Error.Code.Ok) {
    ...
    public void MergeFrom(StatusProto other) {
      ...
      if (other.ErrorCode != global::Tensorflow.Error.Code.Ok) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            ErrorCode = (global::Tensorflow.Error.Code) input.ReadEnum();
            break;
          }
          case 18: {
