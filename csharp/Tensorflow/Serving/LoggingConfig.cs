    ...
    static LoggingConfigReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Tensorflow.Serving.SamplingConfig), global::Tensorflow.Serving.SamplingConfig.Parser, new[]{ "SamplingRate" }, null, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::Tensorflow.Serving.LoggingConfig), global::Tensorflow.Serving.LoggingConfig.Parser, new[]{ "LogCollectorConfig", "SamplingConfig" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class LoggingConfig : pb::IMessage<LoggingConfig> {
    ...
    public void MergeFrom(LoggingConfig other) {
      ...
      if (other.logCollectorConfig_ != null) {
        if (logCollectorConfig_ == null) {
          LogCollectorConfig = new global::Tensorflow.Serving.LogCollectorConfig();
        }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            ...
            input.ReadMessage(LogCollectorConfig);
            break;
          }
          case 18: {
            if (samplingConfig_ == null) {
