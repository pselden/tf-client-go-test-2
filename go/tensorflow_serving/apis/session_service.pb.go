...
type SessionRunRequest struct {
	...
	Options              *protobuf1.RunOptions `protobuf:"bytes,5,opt,name=options,proto3" json:"options,omitempty"`
...
func (m *SessionRunRequest) GetOptions() *protobuf1.RunOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
type SessionRunResponse struct {
	...
	Metadata             *protobuf1.RunMetadata `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *SessionRunResponse) GetMetadata() *protobuf1.RunMetadata {
	if m != nil {
		return m.Metadata
	}
	return nil
