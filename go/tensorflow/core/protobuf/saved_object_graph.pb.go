...
type SavedVariable struct {
	...
	Synchronization      framework1.VariableSynchronization `protobuf:"varint,4,opt,name=synchronization,proto3,enum=tensorflow.VariableSynchronization" json:"synchronization,omitempty"`
	Aggregation          framework1.VariableAggregation     `protobuf:"varint,5,opt,name=aggregation,proto3,enum=tensorflow.VariableAggregation" json:"aggregation,omitempty"`
...
func (m *SavedVariable) GetSynchronization() framework1.VariableSynchronization {
	if m != nil {
		return m.Synchronization
	}
	return framework1.VariableSynchronization_VARIABLE_SYNCHRONIZATION_AUTO
}

func (m *SavedVariable) GetAggregation() framework1.VariableAggregation {
	if m != nil {
		return m.Aggregation
	}
	return framework1.VariableAggregation_VARIABLE_AGGREGATION_NONE
}
