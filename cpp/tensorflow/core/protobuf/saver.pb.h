...
class SaverDef :
 ...
 public:
  ...
  void _internal_set_filename_tensor_name(const std::string& value);
  ...
  void _internal_set_save_tensor_name(const std::string& value);
  ...
  void _internal_set_restore_op_name(const std::string& value);
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_max_to_keep() const;
  void _internal_set_max_to_keep(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
inline void SaverDef::set_filename_tensor_name(const std::string& value) {
  _internal_set_filename_tensor_name(value);
...
inline std::string* SaverDef::mutable_filename_tensor_name() {
  ...
  return _internal_mutable_filename_tensor_name();
}
...
inline void SaverDef::set_save_tensor_name(const std::string& value) {
  _internal_set_save_tensor_name(value);
...
inline std::string* SaverDef::mutable_save_tensor_name() {
  ...
  return _internal_mutable_save_tensor_name();
}
...
inline void SaverDef::set_restore_op_name(const std::string& value) {
  _internal_set_restore_op_name(value);
...
inline std::string* SaverDef::mutable_restore_op_name() {
  ...
  return _internal_mutable_restore_op_name();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 SaverDef::_internal_max_to_keep() const {
  return max_to_keep_;
}
...
inline void SaverDef::_internal_set_max_to_keep(::PROTOBUF_NAMESPACE_ID::int32 value) {
