...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SavedBareConcreteFunction_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SavedBareConcreteFunction_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto}, {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<9> scc_info_SavedObject_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 9, 0, InitDefaultsscc_info_SavedObject_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fsaved_5fobject_5fgraph_2eproto, "tensorflow/core/protobuf/saved_object_graph.proto", 2153,
...
::PROTOBUF_NAMESPACE_ID::uint8* SavedObject::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_children(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(3, this->_internal_slot_variables(i), target, stream);
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_identifier(), ptr, ctx, "tensorflow.SavedUserObject.identifier");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_metadata(), ptr, ctx, "tensorflow.SavedUserObject.metadata");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_concrete_functions(), ptr, ctx, "tensorflow.SavedFunction.concrete_functions");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else goto handle_unusual;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          _internal_add_bound_inputs(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
SavedBareConcreteFunction::SavedBareConcreteFunction(const SavedBareConcreteFunction& from)
  ...
  if (!from._internal_concrete_function_name().empty()) {
    concrete_function_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_concrete_function_name(),
      GetArenaNoVirtual());
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_concrete_function_name(), ptr, ctx, "tensorflow.SavedBareConcreteFunction.concrete_function_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_argument_keywords(), ptr, ctx, "tensorflow.SavedBareConcreteFunction.argument_keywords");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<18>(ptr));
        } else goto handle_unusual;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_operation(), ptr, ctx, "tensorflow.SavedConstant.operation");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 50)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.SavedVariable.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_device(), ptr, ctx, "tensorflow.SavedResource.device");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
