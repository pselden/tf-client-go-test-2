...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_RunOptions_Experimental_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_RunOptions_Experimental_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto}, {}};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 107, -1, sizeof(::tensorflow::ConfigProto)},
  { 128, -1, sizeof(::tensorflow::RunOptions_Experimental)},
  { 135, -1, sizeof(::tensorflow::RunOptions)},
  { 147, -1, sizeof(::tensorflow::RunMetadata_FunctionGraphs)},
  { 155, -1, sizeof(::tensorflow::RunMetadata)},
  { 164, -1, sizeof(::tensorflow::TensorConnection)},
  { 171, 178, sizeof(::tensorflow::CallableOptions_FeedDevicesEntry_DoNotUse)},
  { 180, 187, sizeof(::tensorflow::CallableOptions_FetchDevicesEntry_DoNotUse)},
  { 189, -1, sizeof(::tensorflow::CallableOptions)},
};
...
const char descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001(\010\022:\n\014experimental\030\020 \001(\0132$.tensorflow.C"
  "onfigProto.Experimental\0322\n\020DeviceCountEn"
  "try\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\005:\0028\001\032\260\003\n\014"
  "Experimental\022\037\n\027collective_group_leader\030"
  "\001 \001(\t\022\025\n\rexecutor_type\030\003 \001(\t\022\032\n\022recv_buf"
  "_max_chunk\030\004 \001(\005\022\031\n\021use_numa_affinity\030\005 "
  "\001(\010\0225\n-collective_deterministic_sequenti"
  "al_execution\030\006 \001(\010\022\027\n\017collective_nccl\030\007 "
  "\001(\010\0226\n.share_session_state_in_clusterspe"
  "c_propagation\030\010 \001(\010\022\037\n\027disable_thread_sp"
  "inning\030\t \001(\010\022(\n share_cluster_devices_in"
  "_session\030\n \001(\010\0225\n\020session_metadata\030\013 \001(\013"
  "2\033.tensorflow.SessionMetadata\022!\n\031optimiz"
  "e_for_static_graph\030\014 \001(\010J\004\010\002\020\003\"\330\003\n\nRunOp"
  "tions\0226\n\013trace_level\030\001 \001(\0162!.tensorflow."
  "RunOptions.TraceLevel\022\025\n\rtimeout_in_ms\030\002"
  " \001(\003\022\034\n\024inter_op_thread_pool\030\003 \001(\005\022\037\n\027ou"
  "tput_partition_graphs\030\005 \001(\010\022/\n\rdebug_opt"
  "ions\030\006 \001(\0132\030.tensorflow.DebugOptions\022*\n\""
  "report_tensor_allocations_upon_oom\030\007 \001(\010"
  "\0229\n\014experimental\030\010 \001(\0132#.tensorflow.RunO"
  "ptions.Experimental\032J\n\014Experimental\022\034\n\024c"
  "ollective_graph_key\030\001 \001(\003\022\034\n\024use_run_han"
  "dler_pool\030\002 \001(\010\"R\n\nTraceLevel\022\014\n\010NO_TRAC"
  ...
  "hs\030\001 \003(\0132\024.tensorflow.GraphDef\0224\n\026pre_op"
  "timization_graph\030\002 \001(\0132\024.tensorflow.Grap"
  "hDef\0225\n\027post_optimization_graph\030\003 \001(\0132\024."
  "tensorflow.GraphDef\":\n\020TensorConnection\022"
  "\023\n\013from_tensor\030\001 \001(\t\022\021\n\tto_tensor\030\002 \001(\t\""
  "\260\003\n\017CallableOptions\022\014\n\004feed\030\001 \003(\t\022\r\n\005fet"
  "ch\030\002 \003(\t\022\016\n\006target\030\003 \003(\t\022+\n\013run_options\030"
  "\004 \001(\0132\026.tensorflow.RunOptions\0227\n\021tensor_"
  "connection\030\005 \003(\0132\034.tensorflow.TensorConn"
  "ection\022B\n\014feed_devices\030\006 \003(\0132,.tensorflo"
  "w.CallableOptions.FeedDevicesEntry\022D\n\rfe"
  "tch_devices\030\007 \003(\0132-.tensorflow.CallableO"
  "ptions.FetchDevicesEntry\022\027\n\017fetch_skip_s"
  "ync\030\010 \001(\010\0322\n\020FeedDevicesEntry\022\013\n\003key\030\001 \001"
  "(\t\022\r\n\005value\030\002 \001(\t:\0028\001\0323\n\021FetchDevicesEnt"
  "ry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001B-\n\030or"
  "g.tensorflow.frameworkB\014ConfigProtosP\001\370\001"
  "\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto, "tensorflow/core/protobuf/config.proto", 4649,
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_collective_ring_order(), ptr, ctx, "tensorflow.GPUOptions.Experimental.collective_ring_order");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* GPUOptions_Experimental::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_virtual_devices(i), target, stream);
  }
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_allocator_type(), ptr, ctx, "tensorflow.GPUOptions.allocator_type");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_visible_device_list(), ptr, ctx, "tensorflow.GPUOptions.visible_device_list");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_global_name(), ptr, ctx, "tensorflow.ThreadPoolOptionProto.global_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_compression_algorithm(), ptr, ctx, "tensorflow.RPCOptions.compression_algorithm");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.SessionMetadata.name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int64 version = 2;
...
ConfigProto_Experimental::ConfigProto_Experimental(const ConfigProto_Experimental& from)
  ...
  ::memcpy(&recv_buf_max_chunk_, &from.recv_buf_max_chunk_,
    static_cast<size_t>(reinterpret_cast<char*>(&optimize_for_static_graph_) -
    reinterpret_cast<char*>(&recv_buf_max_chunk_)) + sizeof(optimize_for_static_graph_));
...
void ConfigProto_Experimental::SharedCtor() {
  ...
  ::memset(&session_metadata_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&optimize_for_static_graph_) -
      reinterpret_cast<char*>(&session_metadata_)) + sizeof(optimize_for_static_graph_));
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_collective_group_leader(), ptr, ctx, "tensorflow.ConfigProto.Experimental.collective_group_leader");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_executor_type(), ptr, ctx, "tensorflow.ConfigProto.Experimental.executor_type");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_device_filters(), ptr, ctx, "tensorflow.ConfigProto.device_filters");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* ConfigProto::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(12, this->_internal_session_inter_op_thread_pool(i), target, stream);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RunMetadata_FunctionGraphs::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_partition_graphs(i), target, stream);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RunMetadata::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(3, this->_internal_partition_graphs(i), target, stream);
  }
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(4, this->_internal_function_graphs(i), target, stream);
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_from_tensor(), ptr, ctx, "tensorflow.TensorConnection.from_tensor");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string to_tensor = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_to_tensor(), ptr, ctx, "tensorflow.TensorConnection.to_tensor");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_feed(), ptr, ctx, "tensorflow.CallableOptions.feed");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else goto handle_unusual;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_fetch(), ptr, ctx, "tensorflow.CallableOptions.fetch");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_target(), ptr, ctx, "tensorflow.CallableOptions.target");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<26>(ptr));
        } else goto handle_unusual;
...
::PROTOBUF_NAMESPACE_ID::uint8* CallableOptions::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(5, this->_internal_tensor_connection(i), target, stream);
  }
