...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fnamed_5ftensor_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fnamed_5ftensor_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fnamed_5ftensor_2eproto, "tensorflow/core/protobuf/named_tensor.proto", 294,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_name(), ptr, ctx, "tensorflow.NamedTensorProto.name");
          CHK_(ptr);
