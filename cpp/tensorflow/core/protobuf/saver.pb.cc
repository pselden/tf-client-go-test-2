...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fprotobuf_2fsaver_2eproto, "tensorflow/core/protobuf/saver.proto", 450,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_filename_tensor_name(), ptr, ctx, "tensorflow.SaverDef.filename_tensor_name");
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_save_tensor_name(), ptr, ctx, "tensorflow.SaverDef.save_tensor_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_restore_op_name(), ptr, ctx, "tensorflow.SaverDef.restore_op_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 max_to_keep = 4;
