...
class DebuggedSourceFile :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_last_modified() const;
  void _internal_set_last_modified(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 DebugTensorWatch::_internal_output_slot() const {
  return output_slot_;
}
...
inline void DebugTensorWatch::_internal_set_output_slot(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline std::string* DebugTensorWatch::add_debug_ops() {
  ...
  return _internal_add_debug_ops();
}
...
inline std::string* DebugTensorWatch::add_debug_urls() {
  ...
  return _internal_add_debug_urls();
}
...
inline ::tensorflow::DebugTensorWatch* DebugOptions::add_debug_tensor_watch_opts() {
  ...
  return _internal_add_debug_tensor_watch_opts();
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 DebugOptions::_internal_global_step() const {
  return global_step_;
}
...
inline void DebugOptions::_internal_set_global_step(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 DebuggedSourceFile::_internal_last_modified() const {
...
inline void DebuggedSourceFile::_internal_set_last_modified(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 DebuggedSourceFile::_internal_bytes() const {
  return bytes_;
}
...
inline void DebuggedSourceFile::_internal_set_bytes(::PROTOBUF_NAMESPACE_ID::int64 value) {
