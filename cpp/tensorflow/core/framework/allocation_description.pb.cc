...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto, "tensorflow/core/framework/allocation_description.proto", 367,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_allocator_name(), ptr, ctx, "tensorflow.AllocationDescription.allocator_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
