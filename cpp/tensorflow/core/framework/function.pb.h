...
class GradientDef :
 ...
 public:
  ...
  void _internal_set_gradient_func(const std::string& value);
...
inline void GradientDef::set_gradient_func(const std::string& value) {
  _internal_set_gradient_func(value);
...
inline std::string* GradientDef::mutable_gradient_func() {
  ...
  return _internal_mutable_gradient_func();
}
