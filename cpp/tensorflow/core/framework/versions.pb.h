...
class VersionDef :
 ...
 public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_bad_consumers(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::int32 >&
      _internal_bad_consumers() const;
  void _internal_add_bad_consumers(::PROTOBUF_NAMESPACE_ID::int32 value);
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_producer() const;
  void _internal_set_producer(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_min_consumer() const;
  void _internal_set_min_consumer(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::_internal_producer() const {
  return producer_;
}
...
inline void VersionDef::_internal_set_producer(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::_internal_min_consumer() const {
...
inline void VersionDef::_internal_set_min_consumer(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 VersionDef::_internal_bad_consumers(int index) const {
...
inline void VersionDef::_internal_add_bad_consumers(::PROTOBUF_NAMESPACE_ID::int32 value) {
