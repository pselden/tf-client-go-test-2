...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_tensorflow_5fserving_2futil_2fstatus_2eproto_deps[1] = {
  &::descriptor_table_tensorflow_2fcore_2flib_2fcore_2ferror_5fcodes_2eproto,
};
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_error_message(), ptr, ctx, "tensorflow.serving.StatusProto.error_message");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
