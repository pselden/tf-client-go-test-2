 ...
 public:
  ...
  class ExperimentalWithCallbackMethod_SessionRun : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::tensorflow::serving::SessionRunRequest, ::tensorflow::serving::SessionRunResponse>(
          [this](::grpc::ServerContext* context,
                 const ::tensorflow::serving::SessionRunRequest* request,
                 ::tensorflow::serving::SessionRunResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->SessionRun(context, request, response, controller);
                 }));
    }
    ...
    virtual void SessionRun(::grpc::ServerContext* /*context*/, const ::tensorflow::serving::SessionRunRequest* /*request*/, ::tensorflow::serving::SessionRunResponse* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  ...
  class ExperimentalWithRawCallbackMethod_SessionRun : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(0,
        new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->SessionRun(context, request, response, controller);
                 }));
    }
    ...
    virtual void SessionRun(::grpc::ServerContext* /*context*/, const ::grpc::ByteBuffer* /*request*/, ::grpc::ByteBuffer* /*response*/, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
