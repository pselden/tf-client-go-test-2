    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_mutable_method_name(), ptr, ctx, "tensorflow.serving.InferenceTask.method_name");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* MultiInferenceRequest::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_tasks(i), target, stream);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* MultiInferenceResponse::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0,
    ...
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(1, this->_internal_results(i), target, stream);
  }
