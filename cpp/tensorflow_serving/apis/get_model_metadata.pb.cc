    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(_internal_add_metadata_field(), ptr, ctx, "tensorflow.serving.GetModelMetadataRequest.metadata_field");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
